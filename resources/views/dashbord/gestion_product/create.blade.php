...
<form action="{{route('gestion_product.store')}}" enctype="multipart/form-data" method="post">
@csrf
  <div class="relative z-0 w-full mb-6 group">
      <input type="text" name="name_product" id="name_product" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
  ...
  <div class="grid md:grid-cols-3 md:gap-6">
    <div class="relative z-0 w-full mb-6 group">
        <input type="text" name="product_stock" id="product_stock" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
    ...
    <label for="underline_select" class="sr-only">Category</label>
        <select name="category" id="underline_select" class="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
            <option selected value="pc_gamer">PC Gamer</option>      
            <option value="pc_portable">Pc Portable</option>
            <option value="motherboard">Motherboard</option>
            <option value="Processor">Processor Intel AND Ryzen</option>
            <option value="storage">Storage SSD & HDD</option>
            <option value="ram">RAM</option>
            <option value="carte_graphic">Graphic card </option>
    ...
    <div class="relative z-0 w-full mb-6 group">
        <input type="text" name="product_price" id="floating_last_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
...
<input class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" aria-describedby="user_avatar_help" id="product_picture" name="product_picture" type="file">
  ...
  <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mt-10">ADD</button>
</form>
