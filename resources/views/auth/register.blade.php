        ...
        <div class="w-full">
            <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
                ...
                <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST"
                    ...
                    <div class="flex flex-wrap">
                        <label for="adress" class="block text-gray-700 text-sm font-bold mb-2 sm:mb-4">
                            {{ __('Adress') }}:
                        </label>

                        <input id="adress" type="text" class="form-input w-full @error('adress')  border-red-500 @enderror"
                    ...
                    <div class="flex flex-wrap">
                        <label for="date_born" class="block text-gray-700 text-sm font-bold mb-2 sm:mb-4">
                            {{ __('Date of born') }}:
                        </label>

                        <input id="date_born" type="date" class="form-input w-full @error('date_born')  border-red-500 @enderror"
                            name="date_born" value="{{ old('date_born') }}" required autocomplete="date_born" autofocus>
